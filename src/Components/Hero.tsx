...
const Hero = () => {
    return (
        <div className='mx-auto px-8 flex flex-col items-center justify-center md:flex-row md:items-center md:justify-between'>
            <div className="md:w-1/2 md:mr-4">
                ...
                <p className='my-4 text-gray-600 md:text-start text-center'>A highly motivated student studying Artificial Intelligence 
